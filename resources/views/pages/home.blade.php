...
<html lang="en" class="scroll-smooth">
    ...
    <body>
                            ...
                            >
                                <ul class="block lg:flex 2xl:ml-20">
                                    <li class="group relative">
                                        <a
                                                href="#home"
                                                class="ud-menu-scroll mx-8 flex py-2 text-base font-medium text-dark group-hover:text-primary hover:text-primary dark:text-white lg:mr-0 lg:inline-flex lg:px-0 lg:py-6 lg:text-white lg:group-hover:text-white lg:group-hover:opacity-70"
                                        >
                                            Home
                                        </a>
                                    </li>
                    ...
                    <div class="w-full px-4">
                        <div class="hero-content wow fadeInUp mx-auto max-w-[780px] text-center" data-wow-delay=".2s">
                            ...
                            <ul class="mb-10 flex flex-wrap items-center justify-center gap-5">
                                <li>
                                    <a
                                            href="{{ \App\Filament\Resources\WafVersionResource::getUrl() }}"
                    ...
                    <div class="-mx-4 flex flex-wrap items-stretch">
                        <div class="w-full px-4">
                            <div class="mx-auto max-w-[570px] text-center">
                                ...
                                <a href="{{ url('app/login') }}" class="inline-block rounded-md border border-transparent bg-gray-300/30 px-7 py-3 text-base font-medium text-white transition hover:bg-[#0BB489]">
                                    Start using Arcane
                                </a>
                            </div>
                        </div>
        ...
        <footer class="wow fadeInUp relative z-10 bg-[#090E34] pt-20 lg:pt-[100px]" data-wow-delay=".15s">
            <div class="container">
                <div class="-mx-4 flex flex-nowrap justify-between">
                    ...
                    <div class="flex gap-16 w-full justify-end">
                        <div class="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
                            <div class="mb-10 w-full">
                                <h4 class="mb-9 text-lg font-semibold text-white">About Us</h4>
                                <ul>
                                    <li>
                                        <a href="{{ url('/') }}" class="mb-3 inline-block text-base text-white hover:text-primary">
                                            Home
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#about" class="mb-3 inline-block text-base text-white hover:text-primary">
                                            About
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#pricing" class="mb-3 inline-block text-base text-white hover:text-primary">
                                            Pricing
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#contact" class="mb-3 inline-block text-base text-white hover:text-primary">
                                            Contact
                                        </a>
                                    </li>
                                </ul>
                        ...
                        <div class="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-3/12 xl:w-2/12">
                            <div class="mb-10 w-full">
                                ...
                                <ul>
                                    <li>
                                        <a href="https://securas.fr/services/#pentest" class="mb-3 inline-block text-base text-white hover:text-primary">
                                            Web Pen-testing
                                        </a>
                                    </li>
                                    <li>
                                        <a href="https://securas.fr/services/#security" class="mb-3 inline-block text-base text-white hover:text-primary">
                                            Web Security
                                        </a>
                                    </li>
                                    <li>
                        ...
                        <div class="w-full px-4 md:w-1/3 lg:w-1/2">
                            <div class="my-1 flex justify-center md:justify-end">
                                <p class="text-base text-white">
                                    ...
                                    <a href="https://github.com/MrF0o" rel="nofollow noopner" target="_blank" class="text-gray-1 hover:underline">
                                        Fathi Helmi
                                    </a>
                                </p>
                            </div>
